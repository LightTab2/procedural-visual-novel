...
// #include "Global.h"
// 
// #include "pvnLib/Novel/Action/Visual/Effect/ActionEffect.h"
// 
//// /[optional] Creates a Blur Effect at some point in a SceneryObject or the entire Viewport
...
// 
// private:
// 	///Needed for Serialization, to know the class of an object about to be Serialization loaded///\return SerializationID corresponding to the class of a serialized object
